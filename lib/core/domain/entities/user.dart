...
class User {
  ...
  @override
  String toString() {
    return 'User(_id: $id, city: $city, country: $country, createdAt:'
        ' $createdAt, dob: $dob, gender: $gender, idnumber: $idnumber,'
        ' idtype: $idtype, issuingcountry: $issuingcountry, phone: $phone,'
        ' status: $status, updatedAt: $updatedAt, userid: $userid)';
  }
