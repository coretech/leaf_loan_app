...
class LoanTypeDtoOld {
  ...
  factory LoanTypeDtoOld.fromMap(Map<String, dynamic> map) {
    return LoanTypeDtoOld(
      purpose:
          map['purpose'] != null ? List<String>.from(map['purpose']) : null,
      id: map['_id'],
      name: map['name'],
      description: map['description'],
      currencies: List<CurrencyDtoOld>.from(
        // ignore: avoid_dynamic_calls
        map['currencies']?.map((x) => CurrencyDtoOld.fromMap(x)),
      ),
  ...
  factory LoanTypeDtoOld.fromJson(String source) =>
      LoanTypeDtoOld.fromMap(json.decode(source));

  final List<String>? purpose;
  final String id;
  final String name;
  final String description;
  final List<CurrencyDtoOld> currencies;
  ...
  LoanTypeDtoOld copyWith({
    List<String>? purpose,
    String? id,
    String? name,
    String? description,
    List<CurrencyDtoOld>? currencies,
    int? minduration,
    int? maxduration,
    int? interestrate,
    String? image,
  ...
  @override
  String toString() {
    return 'LoanTypeDtoOld(purpose: $purpose, _id: $id, name: $name, description:'
  ...
  bool operator ==(Object other) {
    ...
    return other is LoanTypeDtoOld &&
